...
import static ru.tpu.hostel.booking.common.logging.Message.FINISH_SERVICE_METHOD_EXECUTION;
import static ru.tpu.hostel.booking.common.logging.Message.FINISH_SERVICE_METHOD_EXECUTION_WITH_RESULT;
import static ru.tpu.hostel.booking.common.logging.Message.SERVICE_METHOD_EXECUTION_EXCEPTION;
import static ru.tpu.hostel.booking.common.logging.Message.START_SERVICE_METHOD_EXECUTION;
import static ru.tpu.hostel.booking.common.logging.Message.START_SERVICE_METHOD_EXECUTION_WITH_PARAMETERS;
...
public class ServiceLoggingFilter {
    ...
    @Around("execution(public * ru.tpu.hostel.booking.service..*(..)) && !execution(* *..ApplicationRunner.*(..))")
