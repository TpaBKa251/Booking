package ru.tpu.hostel.booking.aspect.amqp;
...
public class AmqpMessageSenderLoggingAspect {
    ...
    @Around("execution(* ru.tpu.hostel.booking.rabbit.amqp.AmqpMessageSender.send(..))")
    ...
    @Around("execution(* ru.tpu.hostel.booking.rabbit.amqp.AmqpMessageSender.sendAndReceive(..))")
